...
describe('MyComponent', () => {
  ...
  it('should render the counter value from the Redux store', () => {
    const counterElement = component.getByText(/Counter: 0/i);
    expect(counterElement).toBeInTheDocument();
  });

  it('should dispatch incrementCounter action when increment button is clicked', () => {
    const incrementButton = component.getByText(/Increment/i);
  ...
  it('should dispatch decrementCounter action when decrement button is clicked', () => {
    const decrementButton = component.getByText(/Decrement/i);
